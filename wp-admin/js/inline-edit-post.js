...
//		jQuery('select').wSelect();
		$('#edit-'+id).find('select').wSelect();
		return false;
	},
	...
	save : function(id) {
		...
		/*add by XuYS*/
		$('#edit-'+id+' input.ptitle').val(M2Unicode($('#edit-'+id+' input.ptitle').val()));
//		if ($('#edit-'+id+' input[name=post_name]').length>0) {
//			$('#edit-'+id+' input[name=post_name]').val(Unicode2EN(M2Unicode($('#edit-'+id+' input[name=post_name]').val())));
//		}else {
//			$('#edit-'+id+' input[name=post_name]').val(Unicode2EN(M2Unicode($('#edit-'+id+' input[name=post_title]').val())));
//		}
		$('#edit-'+id+' textarea.tax_input_post_tag').val(M2Unicode($('#edit-'+id+' textarea.tax_input_post_tag').val()));
		params = {
			action: 'inline-save',
			post_type: typenow,
			post_ID: id,
