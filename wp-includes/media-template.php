...
function wp_print_media_templates() {
	...
	<script type="text/html" id="tmpl-media-modal">
		...
		<# 		
		    var media_modal_height = jQuery(window).height()-100;
		    var media_modal_width = jQuery(window).width()-100;
		#>
		<style>
			.media-modal {
				width: {{media_modal_height}}px;
				height:{{media_modal_width}}px;
			}
		</style>
		<#
		jQuery(window).resize(function(){
		    var myheight = jQuery(window).height()-100;
		    var winwidth = jQuery(window).width()-100;
		    var mywidth = jQuery(document).width();
		    jQuery(".media-modal").css("height",winwidth);
		    jQuery(".media-modal").css("width",myheight);
		});
		#>		
		<#
		var flag = false; 
		function checkselect(){
		   if (flag) return;
		   var obj = document.getElementById('media-attachment-filters'); 
		   if (obj) {
		       jQuery(window).ready(function() {
		       		jQuery('.media-modal-content select').wSelect();
	...
	<script type="text/html" id="tmpl-attachment-display-settings">
		...
		<span id="media-attachment-display-settings" style="display:none;"></span>
		<# if ( 'image' === data.type ) { #>
			<div class="setting">
		...
		function checkdisplayselect(){
		   ...
		   var display_obj = document.getElementById('media-attachment-display-settings'); 
		   if (display_obj) {
		       jQuery(window).ready(function() {
		       		jQuery('.media-modal-content select').wSelect();
		       		jQuery('select').change(function() {
		       ...
		       setTimeout(checkdisplayselect, 100);
		   }
		}
		checkdisplayselect();
		#>
	...
	<script type="text/html" id="tmpl-gallery-settings">
		...
		<span id="media-gallery-settings" style="display:none;"></span>
		<div class="setting">
			<span><?php _e('Link To'); ?></span>
			<select class="link-to"
				data-setting="link"
		...
		function checkgalleryselect(){
		   if (gallery_flag) return;
		   var gallery_obj = document.getElementById('media-gallery-settings');
		   if (gallery_obj) {
		       jQuery(window).ready(function() {
		       		jQuery('.media-modal-content select').wSelect();
		       		jQuery('select').change(function() {
		       ...
		       setTimeout(checkgalleryselect, 100);
		   }
		}
		checkgalleryselect();
		#>
	...
	<script type="text/html" id="tmpl-image-details">
		<div class="media-embed">
			<div class="embed-media-settings">
				...
				<div class="column-settings">
					<span id="image-detailss_etting_caption" style="display:none;"></span>
					<?php
					/** This filter is documented in wp-admin/includes/media.php */
					if ( ! apply_filters( 'disable_captions', '' ) ) : ?>
						<label class="setting caption">
		...
		<#
		var details_flag = false; 
		function checkdetailsselect(){
		   if (details_flag) return;
		   var details_obj = document.getElementById('image-detailss_etting_caption'); 
		   if (details_obj) {
		       jQuery(window).ready(function() {
		       		jQuery('.media-modal-content select').wSelect();
		       		jQuery('select').change(function() {
		       ...
		       setTimeout(checkdetailsselect, 100);
		   }
		}
		checkdetailsselect();
		#>
