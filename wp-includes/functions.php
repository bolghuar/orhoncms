...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo content_url( ( WP_DEBUG ? '/languages/css/orhonfont.css' : '/languages/css/orhonfont.css' ) );?>">
	<link rel="stylesheet" type="text/css" href="<?php echo content_url( ( WP_DEBUG ? '/languages/mn-administration.css' : '/languages/mn-administration.css' ) );?>">
