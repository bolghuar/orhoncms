...
function get_sample_permalink_html( $id, $new_title = null, $new_slug = null ) {
	...
	$orhon_post_name_slug=orhon_sanitize_title($post_name);
	if ( false === strpos( $permalink, '%postname%' ) && false === strpos( $permalink, '%pagename%' ) ) {
		...
		$post_name_html = '<span id="editable-post-name" title="' . $title . '">' . $orhon_post_name_slug . '</span>';
		...
		$return .= '<span id="editable-post-name-full">' . $orhon_post_name_slug . "</span>\n";
	}
